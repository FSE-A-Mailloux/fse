(function () {
  ...
  var sections = {
    accueil: {
      root: "/",
      items: [
        { href: "/fse/pr-7/", label: "Accueil" }
      ]
    },
    fse: {
      root: "/fse/",
      items: [
        { href: "/fse/pr-7/fse/", label: "Vue d'ensemble" },
        { href: "/fse/pr-7/fse/comptes-rendus/", label: "Comptes rendus" },
        { href: "/fse/pr-7/fse/fse-les-actions/", label: "Les actions" },
        { href: "/fse/pr-7/fse/fse-les-actions/autres-dons-soutiens/", label: "Autres soutiens" },
        { href: "/fse/pr-7/fse/fse-les-actions/equipements-materiels/", label: "Équipements" },
        { href: "/fse/pr-7/fse/fse-les-actions/photos-de-classe/", label: "Photos de classe" },
        { href: "/fse/pr-7/fse/fse-les-actions/voyages-scolaires/", label: "Voyages scolaires" },
        { href: "/fse/pr-7/fse/fse-qui-sommes-nous/", label: "Qui sommes-nous" }
      ]
    },
    actualites: {
      root: "/actualites/",
      items: [
        { href: "/fse/pr-7/actualites/", label: "Toutes les actualités" },
        { href: "/fse/pr-7/actualites/prochaine-ag/", label: "Prochaine AG" },
        { href: "/fse/pr-7/actualites/ouverture-des-commandes-en-ligne/", label: "Commandes" },
        { href: "/fse/pr-7/actualites/vente-de-brioches/", label: "Vente de brioches" }
      ]
    },
    coopsco: {
      root: "/coopsco/",
      items: [
        { href: "/fse/pr-7/coopsco/", label: "Vue d'ensemble" },
        { href: "/fse/pr-7/coopsco/coopsco-commande/", label: "Commande" }
      ]
    },
    liens: {
      root: "/liens-avec-les-associations/",
      items: [
        { href: "/fse/pr-7/liens-avec-les-associations/", label: "Liens avec les associations" }
      ]
    },
    contact: {
      root: "/nous-contacter/",
      items: [
        { href: "/fse/pr-7/nous-contacter/", label: "Nous contacter" }
      ]
    }
  };
