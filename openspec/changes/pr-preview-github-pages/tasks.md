...
- [x] 6.3 Verifier manuellement, sur l'URL d'un apercu publie, que la feuille de style, le script de navigation et les liens internes se chargent et pointent correctement vers le sous-chemin de l'apercu (plus de 404 sur les assets ni de liens renvoyant vers la racine du domaine)
