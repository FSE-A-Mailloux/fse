...
Le processus de publication SHALL produire, pour chaque destination de menu public publiee et chaque page de contenu associee dans le perimetre, des fichiers HTML et CSS pre-rendus deployables tels quels sur un hebergement statique, sans dependance a un moteur SSG specifique au moment de la livraison. Cette generation SHALL inclure la resolution deterministe de tout partial commun reference par une page source avant ecriture de l'artefact final.
